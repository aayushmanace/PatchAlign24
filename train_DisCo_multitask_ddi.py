    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for n_iter, batch in enumerate(dataloaders[phase]):
                ...
                #Reggularization
                if phase == 'train':
                    num_samples_to_change = int(0.1* label_c.shape[0])
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    loss = loss0 + loss1*alpha + loss2 + loss3*beta + 0.5*multitask_loss
...
if __name__ == '__main__':
    ...
    for holdout_set in ["random_holdout"]: # ["expert_select","random_holdout", "a12", "a34","a56", "dermaamin","br"]:
        ...
        for indexer, label in enumerate([level]):
            ...
            model_ft = Network('vit_disco', [len(label_codes), 6], pretrained=True,num_multitask_classes=78)
